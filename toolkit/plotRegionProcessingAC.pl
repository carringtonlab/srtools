...
my (%opt, $outfile, $species, $confFile, @libs, %reads, %unapproved, @sizes, %sizes, $sth, $region, @hits, $color_mode);
...
sub var_error() {
	...
	print STDERR "  Usage:\n";
	print STDERR "  plotRegionProcessingAC.pl -S <species> -c <conf file> -l <library ID(s)> -o <output file prefix> -R <region>\n";
	print STDERR "\n\n";
