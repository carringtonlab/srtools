...
sub var_error {
	...
	print STDERR "  Usage:\n";
	print STDERR "  seqsToReadsTable.pl -f <sequence file> -l <library_ids> -o <output file> -c <conf_file> -s <species>\n";
	print STDERR "\n\n";
  print STDERR "  -f   The file containing sequences to query. Format is one sequence per line. If FASTA is supplied, headers are skipped.\n\n";
